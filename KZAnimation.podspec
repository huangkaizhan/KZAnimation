...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/huangkaizhan/KZAnimation"
  ...
  s.source       = { :git => "git@github.com:huangkaizhan/KZAnimation.git" }
...
s.source_files  = "MMAnimation/MMAnimation/Classes/**/*.{h,m}"
